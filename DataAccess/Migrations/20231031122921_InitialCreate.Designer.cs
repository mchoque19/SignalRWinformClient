...
namespace DAL.Migrations
{
    ...
    [Migration("20231031122921_InitialCreate")]
            ...
            modelBuilder.Entity("ArticleMonitor", b =>
                {
                    ...
                    b.HasIndex(new[] { "MonitorsId" }, "IX_ArticleMonitor_MonitorsId");

                    b.ToTable("ArticleMonitor", (string)null);
                });
            ...
            modelBuilder.Entity("DAL.Models.Article", b =>
                {
                    ...
                    b.HasIndex(new[] { "DepartmentId" }, "IX_Article_DepartmentId");
            ...
            modelBuilder.Entity("DAL.Models.Department", b =>
                {
                    ...
                    b.HasIndex(new[] { "FamilyId" }, "IX_Department_FamilyId");
            ...
            modelBuilder.Entity("DAL.Models.OrderItem", b =>
                {
                    ...
                    b.HasIndex(new[] { "ArticleId" }, "IX_OrderItem_ArticleId");

                    b.HasIndex(new[] { "PrintOrderGroupId" }, "IX_OrderItem_PrintOrderGroupId");

                    b.HasIndex(new[] { "StateId" }, "IX_OrderItem_StateId");

                    b.ToTable("OrderItem");
                });

            modelBuilder.Entity("DAL.Models.PrintOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DepartmentMonitor", b =>
                {
                    ...
                    b.HasIndex(new[] { "MonitorsId" }, "IX_DepartmentMonitor_MonitorsId");

                    b.ToTable("DepartmentMonitor", (string)null);
                });
            ...
            modelBuilder.Entity("FamilyMonitor", b =>
                {
                    ...
                    b.HasIndex(new[] { "MonitorsId" }, "IX_FamilyMonitor_MonitorsId");

                    b.ToTable("FamilyMonitor", (string)null);
                });
            ...
            modelBuilder.Entity("MonitorState", b =>
                {
                    ...
                    b.HasIndex(new[] { "StatesId" }, "IX_MonitorState_StatesId");
            ...
            modelBuilder.Entity("DAL.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("DAL.Models.PrintOrder", "PrintOrderGroup")
                        .WithMany("OrderItems")
